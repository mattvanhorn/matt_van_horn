...
config :spark,
  formatter: [
    "Ash.Resource": [section_order: [:admin, :authentication, :tokens, :postgres]],
...
config :matt_van_horn, MattVanHornWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: Beacon.Web.ErrorHTML, json: MattVanHornWeb.ErrorJSON],
    layout: false
  ],
...
config :matt_van_horn, MattVanHorn.Mailer, adapter: Swoosh.Adapters.Local
