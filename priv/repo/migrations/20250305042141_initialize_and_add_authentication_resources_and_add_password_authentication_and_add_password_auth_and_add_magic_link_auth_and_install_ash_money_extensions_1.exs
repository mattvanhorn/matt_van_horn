defmodule MattVanHorn.Repo.Migrations.InitializeAndAddAuthenticationResourcesAndAddPasswordAuthenticationAndAddPasswordAuthAndAddMagicLinkAuthAndInstallAshMoneyExtensions1 do
  @moduledoc """
